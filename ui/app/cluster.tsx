...
import { openInBrowser } from './dockerDesktopExtensionUtils';
...
const vscodeApi = { postMessage: (message) => { } };
const openDevSandbox = () => { openInBrowser('https://developers.redhat.com/developer-sandbox'); };
const openContact = () => {
    //FIXME doesn't work, see https://github.com/docker/extensions-sdk/issues/117
    openInBrowser('mailto:devsandbox@redhat.com');
};
const openSlack = () => { openInBrowser('https://dn.dev/DevNationSlack'); };
            ...
            {showWizard === 'sandbox' && (
                <div className={classes.rowBody}>
                    <Card className={classes.cardContent}>
                        ...
                        <Button variant="outlined" onClick={openDevSandbox} className={classes.button} style={{ margin: 15, textTransform: 'none' }}>Learn More</Button>
                        <Button variant="outlined" onClick={openContact} className={classes.button} style={{ margin: 15, textTransform: 'none' }}>Contact Us</Button>
                        <Button variant="outlined" onClick={openSlack} className={classes.button} style={{ margin: 15, textTransform: 'none' }}>Connect on Slack</Button>
                        <AddSandboxView />
                    </Card>
                </div>
            )}
